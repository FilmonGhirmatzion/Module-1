...
public class Exercises {
	...
	public String helloName(String name) {
		 String nameH =new String("Hello " +name+"!" );
	...
	public String makeAbba(String a, String b) {
		String hiByByhi= new String(a+b+b+a);
	...
	public String makeOutWord(String out, String word) {
		...
		// Break string out i to start and end
	...
	public String extraEnd(String str) {
		String copyL =str.substring(str.length()-2);
		String copyLast =copyL+copyL+copyL;
	...
	public String firstTwo(String str) {
		// if string is lengh is less than 2 then return the strung

		// if strng lengh is 2 or greater return just hte first 2 letter
	...
	public String middleTwo(String str) {
       String middleValues= str.substring (((str.length()/2) -1),((str.length()/2) +1  ));
		return middleValues;
	}
	...
	public String twoChar(String str, int index) {
		int stringTwo = str.length();
		if (index >= 0 && (index + 2 <= stringTwo)) {
	...
	public boolean doubleX(String str) {
       ...
       String value = str.substring(x,x+2);
	...
	public String stringBits(String str) {
		 String stringEveryOtherCha ="";
		  for (int i=0; i<str.length(); i= i+2){
		  	stringEveryOtherCha =stringEveryOtherCha +str.substring(i,i+1);
		  }

		return stringEveryOtherCha;
	}
	...
	public String stringSplosion(String str) {
		   ...
		   for (int i= 0; i< str.length(); i++){
		   	nonEmpty = nonEmpty + str.substring(0, i+1);
		   }
		return nonEmpty;
	}
	...
	public String stringX(String str) {
		...
		if(str.length() < 2){
			...
			xremove += str.charAt(0);
		    for (int i= 1; i <str.length()-1; i++){
		    	if (str.charAt(i) !='x'){
		    		xremove= xremove + str.charAt(i);
				}
			}

		}
		    xremove += str.charAt(str.length()-1);
		    return xremove;
	}
