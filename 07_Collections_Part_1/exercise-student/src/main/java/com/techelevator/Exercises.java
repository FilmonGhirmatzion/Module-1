...
public class Exercises {
	...
	public List<String> array2List(String[] stringArray) {
		...
		List<String> array2List = new ArrayList<String>();
			  for(String listItems : stringArray){
			  	array2List.add(listItems);
	...
	public String[] list2Array(List<String> stringList) {
           String[] listItems = new String[(stringList.size())];
           for (int i =0 ; i< listItems.length; i++){
           	listItems[i] = stringList.remove(0);
	...
	public List<Double> arrayInt2ListDouble(int[] intArray) {
            ...
            for ( Integer division: intArray ){
            	dividedByTwo.add(division / 2.0);
			}
	...
	public List<Integer> oddOnly(Integer[] integerArray) {
         List<Integer> oddValue = new ArrayList<Integer>();
         for (Integer oddNumbers : integerArray){

         	if (oddNumbers % 2 != 0){
         		oddValue.add(oddNumbers);
			 }
		 }
		return oddValue;
	}
	...
	public boolean foundIntTwice(List<Integer> integerList, int intToFind) {
		...
		int count= 0;
		for (Integer twoTimesInList : integerList){
			if (intToFind == twoTimesInList){
