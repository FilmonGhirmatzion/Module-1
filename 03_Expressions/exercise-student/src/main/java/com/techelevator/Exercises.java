...
public class Exercises {
	...
	public boolean monkeyTrouble(boolean aSmile, boolean bSmile) {
		// if both monkey smill then trouble
...
//			inTrouble = true;
//	// if neither monekey smillin then in trouble
//		if(!aSmile&& !bSmile){
//			inTrouble=true;
//		}
//		// one smilling and one is not then in trouble
//		return inTrouble;
//
	}
	...
	public boolean or35(int n) {
		...
		if ((n % 5) == 0) multipleOfThreeOrFive = true;
		if ((n % 3) == 0) multipleOfThreeOrFive = true;
		return multipleOfThreeOrFive;
	}
	...
	public int max1020(int a, int b) {
		boolean isAWithinRange = (a >= 10 && a <= 20);
		boolean isBWithinRange = (a >= 10 && b <= 20);

		if ((isAWithinRange && (a > b)) || (isAWithinRange && !isBWithinRange)) {
			return a;
		} else if ((isBWithinRange && (a < b)) || (!isAWithinRange && isBWithinRange)) {
			return b;
		}
		return 0;
	}
